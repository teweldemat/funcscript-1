...
const { FileExistsFunction } = require('./os/FileExistsFunction');
const { IsFileFunction } = require('./os/IsFileFunction');
const { DirectoryListFunction } = require('./os/DirectoryListFunction');
const { FileTextFunction } = require('./os/FileTextFunction');
