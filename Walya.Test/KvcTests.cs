...
namespace Walya.Test
{
    ...
    internal class KvcTests
    {
        ...
        public void TestKvcSimple()
        {
            ...
            var res = WalyaRuntime.Evaluate(g, "{a:3,c:5}");
            var expected = new ObjectKvc(new { a = 3, c = 5 });
            Assert.AreEqual(WalyaRuntime.FormatToJson(expected),  WalyaRuntime.FormatToJson(res));
        }
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:3,c:5,d:a*c}");
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:3,c:5,d:a*c,return d}");
            var expected = 15;
            Assert.AreEqual(expected, res);
        }
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:4,b:5,c:6,return {a,c}}");
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:4,b:5,c:6,return {x:a,y:c}}");
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:4,b:5,c:6}{a,c}");
            var expected = new ObjectKvc(new { a = 4, c = 6 });
            Assert.AreEqual(expected, res);
        }
        ...
        // {
        //     var g = new DefaultFsDataProvider();
        //     var res = WalyaRuntime.Evaluate(g, "{a:4}(a+1)");
        //     var expected = 5;
        //     Assert.AreEqual(expected, res);
        // }
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:4}{a:a}");
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:4}{a:a+1}");
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:4}{a,b:5}");
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:{id:3}}.a.id\r\n");
            var expected = 3;
            ;
            Assert.AreEqual(expected, res);
        }
...
@"{
    ...
    a:2;
      return [4,5] map (x)=>x+a;
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:{id:3}}.a");
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:4,b:5,c:6} {a,c,z:45}");
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "{a:5,b:6}");
            var jsonStr = WalyaRuntime.FormatToJson(res);
    ...
    [Test]
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "[{a:4,b:5,c:6},{a:7,b:8,c:9}]\n{a,c}") as FsList;
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, "((x)=>((y)=>3*y))(0)(2)");
            var expected = 6;
            Assert.AreEqual(expected, res);
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, @"{
z:Map([1,2,3],(x)=>x*x),
return Map(z,(x)=>x*x);
}") as FsList;
            Assert.IsNotNull(res);
        ...
        {
            var g = new DefaultFsDataProvider();
            var res = WalyaRuntime.Evaluate(g, @"{a:12,b:{c:10,z:10}}+{d:13,b:{c:12,x:5}}");
        ...
        public void TestDelegate()
        {
            ...
            Assert.AreEqual(4, WalyaRuntime.EvaluateWithVars("f(3)", vars));
        }
        ...
        public void TestDelegateRejectOut()
        {
            Assert.Throws(typeof(Error.TypeMismatchError)
                , () =>
                {
                    ...
                    var ret = WalyaRuntime.EvaluateWithVars("f(3)", vars);
                });
        }
        [Test]
        ...
        public void ByteArray()
        {
            ...
            var b = WalyaRuntime.EvaluateWithVars("x", new { x = bytes });
...
d";
            ...
            WalyaRuntime.Format(sb, null, null, false, true);
            var str = sb.ToString();
        ...
        public void TestListParse2()
        {
            ...
            var res = WalyaRuntime.Evaluate(exp) as FsList;
            Assert.NotNull(res);
            Assert.AreEqual(expected, res);
        }
        [Test]
        ...
        public void FromJson1()
        {
            ...
            var res = WalyaRuntime.FromJson(json);
        ...
        {
            var res = WalyaRuntime.FromJson(json);
            var expected = WalyaRuntime.Evaluate(fs);
            Assert.AreEqual( WalyaRuntime.FormatToJson( expected), WalyaRuntime.FormatToJson(res));
        }
        [Test]
        public void ObjectKvRetailCases()
        {
            ...
            var sb = new StringBuilder();
            WalyaRuntime.Format(sb, obj, null, false, true);
            Assert.IsTrue(WalyaRuntime.FormatToJson(sb).Contains("AbC"));
