using global::FunscScript.Block;
using global::FunscScript.Core;
using global::FunscScript.Model;
using FunscScriptParser = global::FunscScript.Core.FunscScriptParser;
using ParseNode = global::FunscScript.Core.FunscScriptParser.ParseNode;
...
namespace FunscScript.Test
{
    internal class ParseTreeTests
    {
        ...
        public void PasreKvcTest()
        {
            ...
            var expText = "{a,b,c}";
            var list = new List<FunscScriptParser.SyntaxErrorData>();
            var exp= FunscScriptParser.Parse(g, expText,out var node,list);
        ...
        public void ParseSimpleInfixExpressionPositions()
        {
            ...
            var expText = "1+2";
            var errors = new List<FunscScriptParser.SyntaxErrorData>();
            var block = FunscScriptParser.Parse(provider, expText, out var node, errors);
        ...
        public void TestColoring()
        {
            ...
            var color = FunscScriptRuntime.ColorParseTree(node).ToArray();
