...
namespace FunscScript.Test
{
    ...
    public class TestGetLiteralMatch
    {
        ...
        public void TestExactMatch()
        {
            ...
            int index = FunscScriptParser.GetLiteralMatch(exp, 0, "Hello");
        ...
        {
            string exp = "Hello, world!";
            int index = FunscScriptParser.GetLiteralMatch(exp, 0, "Goodbye");
        ...
        {
            string exp = "Hello, world!";
            int index = FunscScriptParser.GetLiteralMatch(exp, 0, "Goodbye", "Hello", "Hi");
            Assert.AreEqual(5, index);
        }
        ...
        {
            string exp = "Hello, world!";
            int index = FunscScriptParser.GetLiteralMatch(exp, 20, "Hello");
        ...
        {
            string exp = "Hello, world!";
            int index = FunscScriptParser.GetLiteralMatch(exp, 7, "world");
        ...
        {
            string exp = "Hello, world!";
            int index = FunscScriptParser.GetLiteralMatch(exp, 12, "!");
        ...
        {
            string exp = null;
            Assert.Throws<ArgumentNullException>(() => FunscScriptParser.GetLiteralMatch(exp, 0, "Hello"));
        }
        ...
        public void StressTest()
        {
            ...
            int index = FunscScriptParser.GetLiteralMatch(exp, prefixLength, keywords);
            timer.Stop();
