import * as parserModuleRaw from './parser/funscscript-parser.js';
...
const { FunscScriptParser } = parserModule;
...
function evaluate(expression, provider = new DefaultFsDataProvider()) {
  const { block } = FunscScriptParser.parse(provider, expression);
  if (!block) {
