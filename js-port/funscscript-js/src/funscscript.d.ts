...
export declare class MapDataProvider extends FsDataProvider {
  constructor(map?: Record<string, FunscScriptInput>, parent?: FsDataProvider | null);

  set(name: string, value: FunscScriptInput): void;
  get(name: string): TypedValue | null;
  isDefined(name: string): boolean;
}
...
export declare abstract class ParameterList {
  ...
  abstract getParameter(provider: FsDataProvider, index: number): FunscScriptInput;
}
...
export declare class BaseFunction {
  ...
  evaluate(provider: FsDataProvider, parameters: ParameterList): FunscScriptInput;
...
export declare class ExpressionFunction extends BaseFunction {
  ...
  constructor(parameters: readonly string[], expressionBlock: {
    evaluate(provider: FsDataProvider): FunscScriptInput;
  });
...
export declare class ArrayFsList extends FsList {
  constructor(values: readonly FunscScriptInput[]);
}
...
export declare class SimpleKeyValueCollection extends KeyValueCollection {
  constructor(parent?: FsDataProvider | null);
  constructor(entries: Array<readonly [string, FunscScriptInput]>);
  constructor(parent: FsDataProvider | null, entries: Array<readonly [string, FunscScriptInput]>);
}
...
export declare function ensureTyped(value: FunscScriptInput): TypedValue;
export declare function normalize(value: FunscScriptInput): TypedValue;
...
export declare function colorParseTree(
  node: import('./parser/funscscript-parser').ParseNode | null | undefined
): import('./parser/funscscript-parser').ParseNode[];
...
export { FunscScriptParser, ParseNodeType, ParseNode, ParseResult } from './parser/funscscript-parser';
